...
<template>
  <div class="mx-auto max-w-7xl px-10 sm:px-0">
    <div class="text-gray-400 dark:text-slate-300 py-3 flex justify-center text-center ">
      <small class="px-2 flex self-end flex-col">Feito com:</small>
      ...
      <span class="px-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
             class="icon icon-tabler icons-tabler-outline icon-tabler-coffee  stroke-gray-400 dark:stroke-slate-300 hover:stroke-stone-600 transition-colors duration-300 ease-in-out">
        <path stroke="none" d="M0 0h24v24H0z" filll="none"/>
        <path
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
           stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
           class="icon icon-tabler icons-tabler-outline icon-tabler-heart stroke-slate-00 hover:stroke-red-500 transition-colors duration-300 ease-in-out">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
